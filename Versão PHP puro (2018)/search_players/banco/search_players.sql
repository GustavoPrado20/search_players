...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `cep_usu` varchar(10) DEFAULT NULL,
  `estado_usu` char(2) DEFAULT NULL,
  `cidade_usu` varchar(80) DEFAULT NULL,
  `bairro_usu` varchar(80) DEFAULT NULL,
  ...
  `esporte` int DEFAULT NULL,
  `banner_usuario` varchar(60) DEFAULT NULL,
