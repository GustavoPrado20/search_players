...
@section('conteudo')
    <main>
        <section class="container">
            <section class="row">
                ...
                <section class="col-md-9">
                    ...
                    <form name="editar" method="POST" action="{{ route('config_update_perfil') }}" id="altera_form"
                            ...
                            <figure>
                                ...
                                @else
                                    <img class="foto_media rounded-circle"
                                        src="{{ asset('img/foto_perfis/' . $dadosUsuario['foto']) }}"
                                        alt="Imagem do usuário">
                                @endif
                            </figure>
                            ...
                            <figure>
                                ...
                                @else
                                    <img class="banner d-block"
                                        src="{{ asset('img/banners_perfis/' . $dadosUsuario['banner']) }}"
                                        alt="Banner do Usuário">
                                @endif
                            </figure>
                        ...
                        <section class="form-group row">
                            <section class="col-md-6">
                                ...
                                <input class="form-control" id="nomeU" type="text" name="nome"
                                    value="{{ ucwords($dadosUsuario['nome']) }}" require>
                            </section>
                        </section>
        ...
        <section class="modal fade" id="alterar_usuario" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                ...
                <section class="modal-content">
                    ...
                    <section class="modal-footer">
                        ...
                        <input type="submit" name="alterar" value="Alterar" class="btn btn-primary"
                            data-toggle="modal" data-target="#resposta_alterar">
                        </form>
                    </section>
                </section>
            </section>
        ...
        <section>
            <section class="modal fade" id="senha_incorreta" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <section class="modal-dialog">
                    <section class="modal-content">
                        <section class="modal-header">
        ...
        <section>
            <section class="modal fade" id="alteracao_completa" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <section class="modal-dialog">
                    <section class="modal-content">
                        <section class="modal-header">
