...
function validaCadastro(evt) {
	...
	if (sobrenome.value == "") {
		caixa_snome.innerHTML = "Favor preencha o campo Sobrenome";
	...
	if (email.value == "") {
		caixa_email.innerHTML = "Favor preencha o campo E-mail";
	...
	if (senha.value == "") {
		caixa_senha.innerHTML = "Favor preencha o campo Senha";
		caixa_senha.style.display = 'block';
		contErro += 1;
	} else if (senha.value.length < 8) {
		caixa_senha.innerHTML = "Favor preencha o campo Senha com no mínimo 8 caracteres";
		caixa_senha.style.display = 'block';
		contErro += 1;
	} else {
	...
	if (senha2.value == "") {
		caixa_senha2.innerHTML = "Favor Repita a Senha";
	...
	if (senha.value != "" && senha2.value != "" && senha.value != senha2.value) {
		caixa_senha2.innerHTML = "As senhas são diferentes";
		caixa_senha2.style.display = 'block';
		contErro += 1;
	}
